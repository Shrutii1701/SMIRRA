...
export default function Login() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center py-16 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-[calc(100vh-8rem)]">
      {/* Glow Orbs */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-brand-primary/10 rounded-full blur-3xl pointer-events-none"></div>
      
      <div className="w-full max-w-md z-10 animate-slide-up">
        {/* Brand Text */}
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold tracking-widest text-gradient mb-2">
            SMIRRA
          </h1>
          <p className="text-sm text-slate-400">Initialize your local practice profile to start mock training.</p>
        </div>
